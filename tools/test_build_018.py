#!/usr/bin/env python3
"""Static integrity checks for GymTracker Phoenix 11 Alpha Build 018.
...
def main() -> int:
    ...
    critical_text = {
        ...
        "readme": (ROOT / "README_PHOENIX_11_ALPHA_BUILD_018.txt").read_text(encoding="utf-8"),
    }
    check("versionBuild018", all(BUILD in text for text in critical_text.values()), "algún archivo crítico no contiene 018")
    check("indexTitleBuild018", "Build 018" in critical_text["index"])
    check("serviceWorkerCacheBuild018", "build-018-forge-foundation" in critical_text["sw"])
    check("manifestStartUrlBuild018", '"start_url": "./index.html?v=018"' in critical_text["manifest"])
    ...
    required_forge_assets = {
        "./forge/contracts/shape-contract.js?v=018",
        "./forge/core/forge-action-bus.js?v=018",
        "./forge/core/forge-view-model.js?v=018",
        "./forge/core/forge-diagnostics.js?v=018",
        "./forge/engine/shape-engine.js?v=018",
    ...
    check("forgeScriptsLoadedBeforeApp", critical_text["index"].find("forge/engine/shape-engine.js") < critical_text["index"].find("app.js?v=018"))
    ...
    report = {
        ...
        "release": "Phoenix Forge Foundation 0.1",
        "root": str(ROOT),
        "checks": checks,
